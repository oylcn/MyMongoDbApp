...
{
    public class MongoDbRepositoryBase<TEntity> : IRepository<TEntity> where TEntity : class, new()
    {
        ...
        public GetManyResult<TEntity> GetManyResult()
        {
            ...
            {
                result.Message = $"GetManyResult {ex.Message}";
                result.Success = false;
                result.Result = null;
            }
            return result;
        }
        public async Task<GetManyResult<TEntity>> GetManyResultAsync()
        {
            var result = new GetManyResult<TEntity>();
            try
            {
            ...
            {
                result.Message = $"GetManyResultAsync {ex.Message}";
                result.Success = false;
                result.Result = null;
            }
            return result;
        ...
        public GetOneResult<TEntity> UpdateOne(TEntity entity, string id)
        {
            ...
            {
                result.Message = $"UpdateOne {ex.Message}";
                result.Success = false;
                result.Entity = null;
            }
            return result;
        ...
        public async Task<GetOneResult<TEntity>> UpdateOneAsync(TEntity entity, string id)
        {
            ...
            {
                result.Message = $"UpdateOneAsync {ex.Message}";
                result.Success = false;
                result.Entity = null;
            }
            return result;
